...
<x-app-layout>
    <div class="min-h-screen bg-gray-100 flex items-center justify-center">
        <div class="max-w-7xl mx-auto bg-white p-6 rounded-lg shadow-lg w-full">
            ...
            <table class="min-w-full table-auto border-collapse">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="px-4 py-2 border-b">{{ number_format($total_monthly_payment, 2) }} บาท</td>
                        <td class="px-4 py-2 border-b">{{ number_format($remaining_balance, 2) }} บาท</td>
                    </tr>
                </tbody>
            </table>
